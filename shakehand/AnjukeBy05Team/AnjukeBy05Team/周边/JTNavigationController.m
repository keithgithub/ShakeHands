...
#define theWhitColor [UIColor colorWithRed:252.0/255.0 green:252.0/255.0 blue:252.0/255.0 alpha:1.0]
...
+ (JTWrapViewController *)wrapViewControllerWithViewController:(UIViewController *)viewController {
    ...
    wrapNavController.navigationBar.barTintColor = theWhitColor;
